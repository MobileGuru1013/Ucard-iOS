...
- (void)shareToWeixin
{
    ...
    message.thumbData = UIImagePNGRepresentation([UIImage imageNamed:@"AppIcon40x40"]);
    message.title = NSLocalizedString(@"localized211", nil);
...
- (void)shareToFacebook
{
    ...
    content.contentTitle = @"Ucard send me a real worldwide personalized Postcard, record your story.";
    content.contentURL = [NSURL URLWithString:kAppURL];
...
{
    NSLog(NSLocalizedString(@"localized233",nil));
}
