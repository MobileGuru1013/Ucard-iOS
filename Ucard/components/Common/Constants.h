...
#define kGColor [UIColor colorWithRed:46.0/255.0 green:204.0/255.0 blue:113.0/255.0 alpha:1]
...
#define kENFonts @{@"AlexBrush-Regular": @"AlexBrush-Regular"}

//#define kAppURL @"https://itunes.apple.com/cn/app/qq/id444934666?mt=8"
