...
- (void)show
{
    ...
    UIButton *backgroundView = [[UIButton alloc] initWithFrame:self.frame];
    [backgroundView addTarget:self action:@selector(close) forControlEvents:UIControlEventTouchUpInside];
    backgroundView.backgroundColor = [UIColor clearColor];
    backgroundView.layer.borderColor = [UIColor clearColor].CGColor;
    [backgroundView setImage:nil forState:UIControlStateNormal];
